...
class _RollingInputScreenState extends State<RollingInputScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rolling Input'),
        actions: [
          IconButton(
                    ...
                    child: TextFormField(
                      ...
                      onSaved: (value) {
                        _rollingInput = Rolling(
                          ...
                          weight: _rollingProvider.batchWeight(
                              _rollingInput.batchNumber,
                              DateTime.now(),
                              _rollingInput
                                  .rollingTurn), //In here need to create a method that will return the weight of the batch.
                        );
                      },
                    ),
                  ),
