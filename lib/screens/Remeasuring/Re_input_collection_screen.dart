...
class RemeasuringInputCollectionScreen extends StatefulWidget {
  @override
  _RemeasuringInputCollectionScreenState createState() => _RemeasuringInputCollectionScreenState();
}

class _RemeasuringInputCollectionScreenState extends State<RemeasuringInputCollectionScreen> {
  ...
  Future<void> saveLot() async {
    ...
    if (_fbkey.currentState.validate()) {
      ...
      try {
        ...
        Navigator.of(context).pushNamed('RemeasureLotListScreen');
      } catch (e) {
