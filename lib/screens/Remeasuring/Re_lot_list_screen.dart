...
import 'Re_list_tile_lot_screen.dart';
import 'package:teatrackerappofficer/constants.dart';

class RemeasureLotListScreen extends StatefulWidget {
  final supplierID;
  final supplierName;

  const RemeasureLotListScreen({Key key, this.supplierID, this.supplierName})
      : super(key: key);

  @override
  _RemeasureLotListScreenState createState() => _RemeasureLotListScreenState();
}

class _RemeasureLotListScreenState extends State<RemeasureLotListScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).pushNamed("RemeasureTroughLoadingScreen");
            },
          )
        ],
      ),
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => RemeasureListTileLot(
